...
// The sequence a rider moves an assigned order through. Mirrors the
// "End-to-End Operational Workflow" step 7 in the EZLMS spec.
export const RIDER_STATUS_FLOW: { from: string; next: string; label: string }[] = [
  { from: "ASSIGNED", next: "ACCEPTED", label: "Accept Delivery" },
  { from: "ACCEPTED", next: "ARRIVED", label: "Arrived at Pickup" },
  { from: "ARRIVED", next: "PICKED_UP", label: "Mark Picked Up" },
